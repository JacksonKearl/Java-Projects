...
public class Obf
{
	...
	{
		return (a - (a += ((b.apply((float) m())))) == m) ? a : a(a, m() + m(), b);
	}
	 ...
	 * value returned by typcasting the value passed into the funchion to the new
	 * type of int
	 * 
	 * @param a
	...
	/**
	 * Evaluates and returns the expression returned by evaluating the return
	 * value returned by incrementing the value by the given value In best coding
	 * style, I have neglected the use of hardcoded integer values in favor of
	 * unicoide value equivalents, thus creating a "magic number" free program,
